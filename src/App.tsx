...
export default function App() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white font-sans selection:bg-yellow-500/30">
      ...
      <header className="relative overflow-hidden min-h-[85vh] flex items-center py-16 lg:py-24">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center lg:items-start max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black leading-tight mb-6 text-center lg:text-left drop-shadow-2xl">
            ...
            <p className="text-lg md:text-xl text-gray-300 mb-10 text-center lg:text-left max-w-2xl font-medium drop-shadow-md">
              Pare de perder dinheiro com desorganização e falta de padrão no seu açougue.
            </p>

            <a href="https://wa.link/8xjwzs" target="_blank" rel="noopener noreferrer" className="w-full md:w-auto bg-gradient-to-r from-[#d4af37] via-[#e5c048] to-[#b5952f] hover:from-[#e5c048] hover:via-[#fceabb] hover:to-[#c6a640] text-black font-black py-5 px-10 rounded-lg text-lg md:text-xl transition-all transform hover:-translate-y-1 hover:scale-105 shadow-[0_10px_40px_rgba(212,175,55,0.4)] flex items-center justify-center gap-3 group">
              QUERO TRANSFORMAR MEU AÇOUGUE
              <ChevronRight className="w-6 h-6 group-hover:translate-x-2 transition-transform" />
            </a>

            <div className="mt-10 flex items-center gap-3 text-sm md:text-base font-medium text-gray-300 bg-black/40 backdrop-blur-md py-3 px-6 rounded-full border border-white/10 shadow-xl">
              <span className="text-green-500 animate-bounce">🇧🇷</span>
              Método validado em mais de <strong className="text-white">300 lojas</strong> no Brasil
            </div>
          </div>
        </div>
      </header>
      ...
      <section className="bg-gradient-to-b from-red-900 to-black py-16 border-y border-red-800/50">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-5xl md:text-7xl font-black italic tracking-tighter text-white mb-2 drop-shadow-lg">
            AÇOUGUE PRÓ 2.0
          </h2>
          <p className="text-xl md:text-2xl font-bold text-red-200 uppercase tracking-widest mb-10">
            A Consultoria que te traz lucro
          </p>

          <div className="flex flex-col gap-4 max-w-4xl mx-auto">
            <div className="bg-red-600 text-white font-black uppercase py-3 px-6 md:text-lg rounded shadow-lg border border-red-500 transform -skew-x-6">
              <div className="skew-x-6">Layoutização / Treinamento de Cortes Especiais / Técnicas de Montagem de Balcões</div>
            </div>
            <div className="bg-red-700 text-white font-black uppercase py-3 px-6 md:text-lg rounded shadow-lg border border-red-600 transform -skew-x-6 w-11/12 mx-auto">
              <div className="skew-x-6">Treinamento de Produtos Artesanais</div>
            </div>
            <div className="bg-red-700 text-white font-black uppercase py-3 px-6 md:text-lg rounded shadow-lg border border-red-600 transform -skew-x-6 w-10/12 mx-auto">
              <div className="skew-x-6">Treinamento de Gestão de Açougue</div>
            </div>
            <div className="bg-red-700 text-white font-black uppercase py-3 px-6 md:text-lg rounded shadow-lg border border-red-600 transform -skew-x-6 w-9/12 mx-auto">
              <div className="skew-x-6">Treinamento Operacional do Açougue</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#111]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black mb-4">RESULTADOS VISÍVEIS DE TRANSFORMAÇÃO</h2>
          ...
          <div className="space-y-20 max-w-5xl mx-auto border-t border-neutral-800 pt-16">
            
            {/* CÂMARA FRIA */}
            <div>
              <h3 className="text-2xl md:text-4xl font-black text-center mb-8 uppercase tracking-widest">Câmara Fria</h3>
            ...
            {/* CORTES ESPECIAIS */}
            <div>
              <h3 className="text-2xl md:text-4xl font-black text-center mb-8 uppercase tracking-widest">Cortes Especiais</h3>
            ...
            {/* PRODUTOS ARTESANAIS */}
            <div>
              <h3 className="text-2xl md:text-4xl font-black text-center mb-8 uppercase tracking-widest">Treinamento de Produtos Artesanais</h3>
      ...
      <section className="py-20 bg-black relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black mb-4 text-[#d4af37]">O SISTEMA ESTRUTURADO PARA O SUCESSO</h2>
            <p className="text-gray-400 max-w-2xl mx-auto">Nossa metodologia cobre todos os pilares necessários para transformar seu açougue em uma máquina de vendas.</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 md:gap-6 max-w-6xl mx-auto">
            {[
              ...
              <div key={i} className="bg-white rounded-xl p-6 flex flex-col items-center justify-center text-center gap-4 transform transition-transform hover:-translate-y-2 hover:shadow-[0_10px_30px_rgba(212,175,55,0.2)]">
                <div className="w-16 h-16 rounded-full bg-yellow-50 flex items-center justify-center text-[#d4af37]">
                  <item.icon className="w-8 h-8" />
                </div>
                <h3 className="text-black font-bold text-sm md:text-base uppercase">{item.title}</h3>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* POR QUE ESCOLHER */}
      <section className="py-20 bg-[#111] border-t border-neutral-800">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-black text-center mb-16">POR QUE ESCOLHER A LF CONSULTORIA?</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-5xl mx-auto">
            <div className="flex flex-col items-center text-center space-y-4">
              <div className="w-24 h-24 rounded-full bg-neutral-900 border border-neutral-800 flex items-center justify-center text-[#d4af37]">
                <Beef className="w-12 h-12" />
              </div>
              <h3 className="text-xl font-bold">Especialização no Nicho</h3>
              <p className="text-gray-400 text-sm">Foco 100% em açougues e casas de carnes. Entendemos a sua realidade.</p>
            </div>
            
            <div className="flex flex-col items-center text-center space-y-4">
              <div className="w-24 h-24 rounded-full bg-neutral-900 border border-[#d4af37]/30 flex items-center justify-center text-[#d4af37] relative">
                <BadgeCheck className="w-12 h-12" />
                <div className="absolute -top-2 -right-2 bg-red-600 text-white text-xs font-bold px-2 py-1 rounded-full">300+</div>
              </div>
              <h3 className="text-xl font-bold">Método Validado na Prática</h3>
              <p className="text-gray-400 text-sm">Mais de 300 lojas transformadas em todo o Brasil com resultados reais.</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <h3 className="text-xl font-bold">Resultados Visuais Comprovados</h3>
              <p className="text-gray-400 text-sm">Transformação estética que atrai clientes e aumenta o ticket médio.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* SOLUÇÃO PREMIUM */}
      <section className="py-20 bg-gradient-to-br from-neutral-950 to-red-950 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-red-900/20 to-transparent"></div>
        
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto bg-black/50 backdrop-blur-sm border border-red-900/50 rounded-3xl p-8 md:p-12 shadow-2xl">
            <h2 className="text-3xl md:text-5xl font-black text-[#d4af37] mb-8 text-center">
            ...
            <ul className="space-y-6 mb-12">
              {[
                ...
                <li key={i} className="flex items-start gap-4">
                  ...
                  <span className="text-lg md:text-xl text-gray-200 font-medium">{text}</span>
                </li>
              ))}
            </ul>

            <div className="text-center">
              <a href="https://wa.link/8xjwzs" target="_blank" rel="noopener noreferrer" className="inline-block w-full md:w-auto bg-gradient-to-r from-[#d4af37] to-[#b5952f] hover:from-[#e5c048] hover:to-[#c6a640] text-black font-black py-5 px-12 rounded-lg text-xl transition-all transform hover:scale-105 shadow-[0_0_40px_rgba(212,175,55,0.4)]">
      ...
      {/* VAGAS LIMITADAS */}
      <section className="py-16 bg-[#d4af37] text-black text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-black uppercase mb-2">Vagas limitadas para a próxima turma</h2>
          <p className="text-2xl md:text-3xl font-bold text-red-700 mb-8 animate-pulse">Últimas 7 vagas</p>
          
          <a href="https://wa.link/8xjwzs" target="_blank" rel="noopener noreferrer" className="inline-flex bg-black text-white font-black py-4 px-10 rounded-lg text-xl hover:bg-neutral-800 transition-colors items-center justify-center gap-2 mx-auto">
